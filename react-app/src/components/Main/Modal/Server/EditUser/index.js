  ...
  return (
      <form>
        ...
        <div className="edit-user-btns-container">
            <button className="edit-user-btns" type='button' onClick={() => modal(false)}>Cancel</button>
            <button className="edit-user-btns" type='submit' disabled={errors.length > 0}>Save</button>
        </div>
      </form>
  )
}
